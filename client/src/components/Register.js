      ...
      <div className="cardClass">
        <div className="card-container">
          <div className="form-container">
            <h2 className="register-text card-title">Register</h2>
            <div>
              <form className="card-title" onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  ...
                  {errors.lname && touched.lname ? (
                    <p class="error-message">{errors.lname}</p>
                  ) : null}
                </div>
                <div className="form-group">
                  ...
                  <small id="emailHelp" className="register-text">
                ...
                <div className="form-group">
                  ...
                  {errors.emailId && touched.emailId ? (
                    <p class="error-message">{errors.emailId}</p>
                  ) : null}
                  <small id="emailHelp" className="register-text">
                ...
                <div className="form-group">
                  ...
                  {errors.cpassword && touched.cpassword ? (
                    <p class="error-message">{errors.cpassword}</p>
                  ) : null}
                </div>
                <button
                  type="submit"
